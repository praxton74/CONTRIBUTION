...
ide=0
lis=[]
image=Image.open('auto-car-logo-template-icon-vector-21468702.jpg')
st.image(image, width=100)
st.title("Smart Traffic Surveillance System!!!")

st.write("Upload a video to start Detecting Speed!!!")
tracker = EuclideanDistTracker()
import tempfile

f = st.file_uploader("Upload file",type=["mp4","avi","mov","mkv","flv","wmv","m4v","mjpeg","png","jpg","jpeg","gif","bmp","tiff","tif","raw","webp"])
...
while True:
    ...
    cv2.imshow("ROI", cv2.resize(roi,(1080,680)))
    if sp>40 and id not in lis:
        st.write("alert generated for id : ",ide)
        lis.append(id)
